...
namespace Entities
{
    public interface CharacterDataBank
    {
        ...
        Array<WorkInterface> GetWorks();
        void SetWorks(Array<WorkInterface> _works);
        ...
        Array<Array<CriticUseInterface>> GetCriticUses();
        void SetCriticUses(Array<Array<CriticUseInterface>> uses);

        Array<TechniqueInterface> GetTechniques();
        void SetTechniques(Array<TechniqueInterface> tech);
